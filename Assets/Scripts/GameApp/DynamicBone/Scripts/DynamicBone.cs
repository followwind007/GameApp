...
public class DynamicBone : MonoBehaviour
{
	...
	[Tooltip("在柔布模拟状态下是否关闭dynamic bone")]
	public bool m_DisableWhenClothSim = false;
    ...
    [HideInInspector]
    public Vector3 m_OutSideForce = Vector3.zero;
    ...
    void UpdateParticles1()
    {
        ...
        force = (force + m_Force + m_OutSideForce) * m_ObjectScale;
