...
public static class CustomSettings
{
    ...
    {                
        ...
        _GT(typeof(GameObject)).AddExtendType(typeof(GameObjectEx)),
        ...
        _GT(typeof(ToggleGroupHelper)),
        
        //Manager
        _GT(typeof(EventDispatcher)),
        
        //Behaviour Designer
        _GT(typeof(BehaviorDesigner.Runtime.Behavior)).AddExtendType(typeof(BehaviorDesigner.Runtime.BehaviourEx)),
        _GT(typeof(BehaviorDesigner.Runtime.BehaviorTree)),
        _GT(typeof(BehaviorDesigner.Runtime.BehaviorManager)),
        _GT(typeof(BehaviorDesigner.Runtime.Tasks.Task)),
        _GT(typeof(BehaviorDesigner.Runtime.Tasks.Action)),
        _GT(typeof(BehaviorDesigner.Runtime.Tasks.Conditional)),
        _GT(typeof(BehaviorDesigner.Runtime.Tasks.ActionBinder)),
        
        //DataBinder
        _GT(typeof(BehaviourBinder)).AddExtendType(typeof(BindableTargetImpl)),
        _GT(typeof(StateBinder)).AddExtendType(typeof(BindableTargetImpl)),
        _GT(typeof(BindableValues)),
        ...
        _GT(typeof(KeyValuePair<string, object>)),
        //
        _GT(typeof(Rect)),
        ...
        _GT(typeof(RawImage)),
        _GT(typeof(Text)),
        _GT(typeof(RectTransform)).AddExtendType(typeof(RectTransformEx)),
        _GT(typeof(Canvas)),
