...
public class UnityEngine_RectTransformWrap
{
	public static void Register(LuaState L)
	{
		...
		L.RegFunction("SetParentCenter", new LuaCSFunction(SetParentCenter));
		L.RegFunction("SetParentFull", new LuaCSFunction(SetParentFull));
		...
		L.RegVar("drivenByObject", new LuaCSFunction(get_drivenByObject), null);
	...
	static int GetRect(IntPtr L)
	{
		try
		{
			...
			UnityEngine.Rect o = obj.GetRect(arg0);
			ToLua.PushValue(L, o);
			return 1;
		}
		catch (Exception e)
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int SetParentCenter(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 2);
	...
	[MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
	static int SetParentFull(IntPtr L)
	{
		try
		{
			ToLua.CheckArgsCount(L, 2);
