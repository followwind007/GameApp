...
public static class LuaBinder
{
	public static void Bind(LuaState L)
	{
		...
		L.BeginModule("UI");
		UnityEngine_UI_ToggleGroupHelperWrap.Register(L);
		...
		BehaviorDesigner_Runtime_Tasks_ActionBinderWrap.Register(L);
		L.EndModule();
		L.EndModule();
		L.EndModule();
		L.BeginModule("GameApp");
		L.BeginModule("DataBinder");
		GameApp_DataBinder_BehaviourBinderWrap.Register(L);
		GameApp_DataBinder_StateBinderWrap.Register(L);
		GameApp_DataBinder_BindableValuesWrap.Register(L);
		L.EndModule();
		L.BeginModule("Util");
		GameApp_Util_UIUtilsWrap.Register(L);
		GameApp_Util_UtilsWrap.Register(L);
		L.EndModule();
		L.BeginModule("LogicGraph");
		GameApp_LogicGraph_LogicGraphInstanceWrap.Register(L);
		GameApp_LogicGraph_LogicGraphObjectWrap.Register(L);
		GameApp_LogicGraph_GraphPropertyWrap.Register(L);
		L.BeginModule("LogicGraphObject");
		GameApp_LogicGraph_LogicGraphObject_GraphTypeWrap.Register(L);
		L.EndModule();
		L.EndModule();
		L.EndModule();
