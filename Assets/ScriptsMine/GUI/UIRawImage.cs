...
namespace UnityEngine.UI
{
    ...
    /// </summary>
    [AddComponentMenu("UI/UI Raw Image", 12)]
    public class UIRawImage : MaskableGraphic
    {
        ...
        public override Color color
        {
            get
            {
                Debug.Log("get color" + base.color);
                return base.color;
            }

            set
            {
                Debug.Log("set color:" + base.color);
                base.color = value;
            }
        }

        protected UIRawImage()
        {
        ...
        {
            //Debug.Log("canvas group changed");
        }
        ...
        public override void SetVerticesDirty()
        {
            ...
            Debug.Log("set vert dirty");
        }

        protected override void OnPopulateMesh(VertexHelper vh)
        {
            Debug.Log("polute: " + color);
            Texture tex = mainTexture;
            vh.Clear();
            if (tex != null)
            {
